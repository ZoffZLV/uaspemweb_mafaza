...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 11, 2024 at 03:32 AM
...
(9, 'mafazan123@gmail.com', 'faza', 'faza', '085158161006'),
...
(18, 9, 10, '2024-06-11', 82000, 'Pos Indonesia (3-5 Hari Kerja)', 12000, 'sdssad', 'Tertunda', '');
...
(1, 'The Great Gatsby', 55000, 180, 'tb1.png', ' Novel klasik karya F. Scott Fitzgerald yang menggambarkan kehidupan mewah dan penuh intrik di era Roaring Twenties di Amerika Serikat. bagus', 'tb1alt.png', 6),
(2, 'Sapiens', 75000, 220, 'tb2.png', 'Buku non-fiksi karya Yuval Noah Harari yang merangkum sejarah manusia dari zaman purba hingga masa modern, membahas evolusi, peradaban, dan revolusi kognitif.', 'tb2alt.png', 6),
(3, 'Pride and Prejudice', 48000, 170, 'tb3.png', 'Novel klasik karya Jane Austen yang mengisahkan kisah percintaan antara Elizabeth Bennet dan Mr. Darcy di tengah-tengah norma-norma sosial pada era Regency di Inggris.', 'tb3alt.png', 2),
...
(8, 'Doraemon: Stand By Me', 70000, 120, 'tb8.png', 'Bercerita tentang persahabatan yang terjalin di antara Nobita, Doraemon, dan teman-temannya. Mereka berusaha untuk melawan semua rintangan demi menyelamatkan diri mereka dari ancaman masa depan.', 'tb9alt.png', 5),
